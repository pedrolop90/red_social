...
public class CAccion {
    ...
    public boolean eliminarLike(@PathVariable("id") int id,HttpServletRequest request){
        return sAccion.eliminar(id,Integer.parseInt(JwtUtil.getAuthentication(request)));
    }
